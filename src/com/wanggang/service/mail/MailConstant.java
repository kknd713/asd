...
public class MailConstant {
	...
	/** 邮件配置文件路径 */
	public static final String EMAIL_CONFIG_PATH = "email.properties";

	/*邮件服务器域名*/
	public static final String DOMAIN = "@cdjj.com";
	/** 找回密码自动发送邮件配置 用户名 ,在UserRegisterService类中使用 了 */
	public static final String SENDMAIL_USERNAME = "admin" + DOMAIN;
	/** 找回密码自动发送邮件配置 密码 */
	public static final String SENDMAIL_PASSWORD = "admin";
	/** 找回密码自动发送邮件配置 发件人 */
	public static final String SENDMAIL_FROM = "noreply" + DOMAIN;
}
