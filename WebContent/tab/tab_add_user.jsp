...
<p align="center" style="font-size:36px; font-family:Tahoma, Geneva, sans-serif">添加用户</p>
		<div class="pages">
		  <table  width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            	<tr>
					<td align="right" width="30%">真实姓名：</td>
                    <td align="left"><input type="text" name="users.zsname" id="zsname"/> <font color="red">*</font></td>
				</tr>
            	<tr>
					<td align="right" width="30%">用户名：</td>
                    <td align="left" ><input name="users.username" id="username"  type="text" />                                           
   						 <font color="red">*</font></td>
				</tr>
                <tr>
					<td align="right" width="30%">密码：</td>
                    <td align="left"><input type="password" name="users.userpassword" id="password"/> <font color="red">*</font></td>
				</tr>
