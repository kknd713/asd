                    ...
                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="84%" height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3"><a href="<%=basePath %>tab/tab_add_user.jsp" target="mainFrame">添加用户</a></span></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          ...
                          <td height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3"><a href="<%=basePath %>tab/tab_update_user.jsp" target="mainFrame">修改用户</a></span></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          ...
                          <td height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3"><a href="<%=basePath %>tab/selectusers.action" target="mainFrame">查看用户</a></span></td>
                              </tr>
                          </table></td>
                        </tr>
                          <tr>
